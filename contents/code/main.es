...
function init()
{
    comic.comicAuthor = "Christopher Hastings";
...
// 	comic.nextIdentifier=comic.identifier;
	dat = comic.identifier.addDays(-1);
	while(flag==0){
...
// 	    print(comic.previousIdentifier.toString("yyyy-MM-dd"));
// 	    print(comic.firstIdentifier+comic.previousIdentifier.toString("yyyy-MM-dd"));
	...
	flag=0;dat = comic.identifier.addDays(1);
	while(flag==0){
...
// 	    print(re+" "+comic.identifier.toString("yyyy-MM-dd")+" "+comic.lastIdentifier.toString("yyyy-MM-dd"));
	    var match = re.exec(data);
	    if(match!=null){flag=1}	
	    if(comic.nextIdentifier.toString("yyyy-MM-dd")>=comic.lastIdentifier.toString("yyyy-MM-dd")){flag=1}
// 	    print(flag);
	    dat=dat.addDays(1);
	  }else{
	    //comic.nextIdentifier=comic.identifier;
